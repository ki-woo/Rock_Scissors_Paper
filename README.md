...
$a b^{n-1}$, $b c^{n-1}$, $c a^{n-1}$의 계수 : $\binom{n}{1}$ \
$a^2 b^{n-2}$, $b^2 c^{n-2}$, $c^2 a^{n-2}$의 계수 : $\binom{n}{2}$ \
$a^3 b^{n-3}$, $b^3 c^{n-3}$, $c^3 a^{n-3}$의 계수 : $\binom{n}{3}$\
. . . \
$a^{n-1} b$, $b^{n-1} c$, $c^{n-1} a$의 계수 : $\binom{n}{n-1}$

$a b^{n-1}$, $b c^{n-1}$, $c a^{n-1}$의 계수합 : $3\binom{n}{1}$ \
$a^2 b^{n-2}$, $b^2 c^{n-2}$, $c^2 a^{n-2}$의 계수합 : $3\binom{n}{2}$ \
$a^3 b^{n-3}$, $b^3 c^{n-3}$, $c^3 a^{n-3}$의 계수합 : $3\binom{n}{3}$\
. . . \
$a^{n-1} b$, $b^{n-1} c$, $c^{n-1} a$의 계수합 : $3\binom{n}{n-1}$
...
$E_n = \frac{3\binom{n}{1}}{3^n} + \frac{3\binom{n}{2}}{3^n}(E_2 + 1) + \frac{3\binom{n}{3}}{3^n}(E_3 + 1) + \cdots + \frac{3\binom{n}{n-1}}{3^n}(E_{n-1} + 1) + \frac{3^n - 3(2^n-2)}{3^n}(E_{n} + 1)$

$\frac{2^n-2}{3^{n-1}}E_n = \frac{\binom{n}{2}E_2 + \binom{n}{3}E_3+ \cdots + \binom{n}{n-1}E_{n-1}}{3^{n-1}} + \frac{\binom{n}{1} + \binom{n}{2} + \binom{n}{3} + \cdots + \binom{n}{n-1} - (2^n - 2)}{3^{n-1}} + 1$

$\frac{2^n-2}{3^{n-1}}E_n = \frac{3^{n-1} + \sum_{k=2}^{n-1} {\binom{n}{k}E_k}}{3^{n-1}}$

$\therefore E_n = \frac{3^{n-1} + \sum_{k=2}^{n-1} {\binom{n}{k}E_k}}{2^n-2} \qquad(n\ge2,\ E_1=0)$
